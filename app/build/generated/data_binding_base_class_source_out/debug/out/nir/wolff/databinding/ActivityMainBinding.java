...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull MaterialButton signOutButton, @NonNull Toolbar toolbar,
      @NonNull TextView userEmailText, @NonNull CardView welcomeCard,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((CoordinatorLayout) rootView, bottomActions, createGroupFab,
          groupsRecyclerView, noGroupsText, progressBar, signInButton, signOutButton, toolbar,
          userEmailText, welcomeCard, welcomeText);
    }
